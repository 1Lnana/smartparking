    ...
    <Row :gutter="20">
        ...
        <div class="body">
            ...
            <div class="awayMenu">
                <!--左侧 -->
                <div class="awayLeft">
                    <span style="color:rgba(8, 8, 8, 0.8)" class="manage2">
                        欢迎
                        <!--用户名称 -->
                        <span>{{ name }}</span>
                    </span>
                    <!--登入地址 -->
                    <div style="color:rgba(8, 8, 8, 0.8)" class="manage">登入地址：{{ location }}</div>
                </div>
                <!--时间，上下布局 -->
                <div class="bottom">
                    <!--年月日 -->
            ...
            <!--三层标题 -->
            <div class="bigTips">
                <span style="color:rgba(8, 8, 8, 0.8)">常用模块</span>
...
.button {
    ...
    justify-content: center;
    align-items: center;
    background-color: rgba(70, 62, 62, 0.4);
    border-radius: 10px;
    padding: 20px;
    margin: 0 auto;
    z-index: 99;
